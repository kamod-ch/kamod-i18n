...
export interface I18nProviderProps<TSchema extends MessageTree = MessageTree, TLocale extends string = string> {
...
export function I18nProvider<TSchema extends MessageTree, TLocale extends string>({
  ...
  return <I18nContext.Provider value={i18n as unknown as I18n<MessageTree, string>}>{children}</I18nContext.Provider>
}

/** Read the current i18n instance and rerender when its locale changes. */
export const useI18n = <TSchema extends MessageTree = MessageTree, TLocale extends string = string>(): I18n<
  TSchema,
  TLocale
> => {
